...
to open the devicetree at :file:`build/zephy/zephyr.dts`, which allows the
simple work-flow bellow::
...
Please refer to the DTSh :ref:`User Guide <dtsh-user-guide>` for detailed documentation.
