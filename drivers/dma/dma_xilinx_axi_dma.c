...
#ifdef CONFIG_XILINX_AXI_DMA_DISABLE_CACHE_WHEN_ACCESSING_SG_DESCRIPTORS
...
__aligned(64) static struct dma_xilinx_axi_dma_sg_descriptor
	descriptors_tx[CONFIG_XILINX_AXI_DMA_SG_DESCRIPTOR_NUM_TX] = {0};
__aligned(64) static struct dma_xilinx_axi_dma_sg_descriptor
	descriptors_rx[CONFIG_XILINX_AXI_DMA_SG_DESCRIPTOR_NUM_RX] = {0};
