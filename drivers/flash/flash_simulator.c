...
#if CONFIG_FLASH_SIMULATOR_DIRECT_WRITE
	.direct_write = true,
#endif /* CONFIG_FLASH_SIMULATOR_DIRECT_WRITE */
};
...
#if !CONFIG_FLASH_SIMULATOR_DOUBLE_WRITES && !CONFIG_FLASH_SIMULATOR_DIRECT_WRITE
			return -EIO;
#endif
		}
	}
...
#elif FLASH_SIMULATOR_ERASE_VALUE == 0xFF
