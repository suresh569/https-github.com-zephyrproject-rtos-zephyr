...
#ifdef CONFIG_SPI_NOR_DEEP_POWER_DOWN_INACTIVITY_TIMEOUT_MS
#define DPD_INACTIVITY_TIMEOUT_MS CONFIG_SPI_NOR_DEEP_POWER_DOWN_INACTIVITY_TIMEOUT_MS
#else
#define DPD_INACTIVITY_TIMEOUT_MS 0
#endif
			...
			size_t size)
{
	...
	(void)pm_device_runtime_put_async(dev, K_MSEC(DPD_INACTIVITY_TIMEOUT_MS));
	return ret;
}
