...
void sys_trace_k_msgq_prepend_enter(struct k_msgq *msgq, const void *data, k_timeout_t timeout);
void sys_trace_k_msgq_prepend_blocking(struct k_msgq *msgq, const void *data, k_timeout_t timeout);
void sys_trace_k_msgq_prepend_exit(struct k_msgq *msgq, const void *data, k_timeout_t timeout,
					  int ret);
