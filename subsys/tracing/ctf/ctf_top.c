...
void sys_port_trace_gpio_pin_configured_output(const struct device *port, gpio_pin_t pin, gpio_flags_t flags)
{
	ctf_top_gpio_pin_configured_output((uint32_t)(uintptr_t)port, (uint32_t)pin, (uint32_t)flags);
}

void sys_port_trace_gpio_pin_configured_input(const struct device *port, gpio_pin_t pin, gpio_flags_t flags)
{
	ctf_top_gpio_pin_configured_output((uint32_t)(uintptr_t)port, (uint32_t)pin, (uint32_t)flags);
}

void sys_port_trace_gpio_pin_event_attached(const struct device *port, struct gpio_callback *callback)
{
	ctf_top_gpio_pin_event_attached((uint32_t)(uintptr_t)port, (uint32_t)(uintptr_t)callback);
}

void sys_port_trace_gpio_pin_event_removed(const struct device *port, struct gpio_callback *callback)
{
	ctf_top_gpio_pin_event_removed((uint32_t)(uintptr_t)port, (uint32_t)(uintptr_t)callback);
}

void sys_port_trace_gpio_pin_event_executed(const struct device *port, struct gpio_callback *callback)
{
