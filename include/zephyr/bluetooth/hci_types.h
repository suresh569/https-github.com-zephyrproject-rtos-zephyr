...
static inline const char *bt_hci_err_to_str(uint8_t err)
{
	...
	case BT_HCI_ERR_SUCCESS:
		return "BT_HCI_ERR_SUCCESS(0x00)";
	case BT_HCI_ERR_UNKNOWN_CMD:
		return "BT_HCI_ERR_UNKNOWN_CMD(0x01)";
	case BT_HCI_ERR_UNKNOWN_CONN_ID:
		return "BT_HCI_ERR_UNKNOWN_CONN_ID(0x02)";
	case BT_HCI_ERR_HW_FAILURE:
		return "BT_HCI_ERR_HW_FAILURE(0x03)";
	case BT_HCI_ERR_PAGE_TIMEOUT:
		return "BT_HCI_ERR_PAGE_TIMEOUT(0x04)";
	case BT_HCI_ERR_AUTH_FAIL:
		return "BT_HCI_ERR_AUTH_FAIL(0x05)";
	case BT_HCI_ERR_PIN_OR_KEY_MISSING:
		return "BT_HCI_ERR_PIN_OR_KEY_MISSING(0x06)";
	case BT_HCI_ERR_MEM_CAPACITY_EXCEEDED:
		return "BT_HCI_ERR_MEM_CAPACITY_EXCEEDED(0x07)";
	case BT_HCI_ERR_CONN_TIMEOUT:
		return "BT_HCI_ERR_CONN_TIMEOUT(0x08)";
	case BT_HCI_ERR_CONN_LIMIT_EXCEEDED:
		return "BT_HCI_ERR_CONN_LIMIT_EXCEEDED(0x09)";
	case BT_HCI_ERR_SYNC_CONN_LIMIT_EXCEEDED:
		return "BT_HCI_ERR_SYNC_CONN_LIMIT_EXCEEDED(0x0a)";
	case BT_HCI_ERR_CONN_ALREADY_EXISTS:
		return "BT_HCI_ERR_CONN_ALREADY_EXISTS(0x0b)";
	case BT_HCI_ERR_CMD_DISALLOWED:
		return "BT_HCI_ERR_CMD_DISALLOWED(0x0c)";
	case BT_HCI_ERR_INSUFFICIENT_RESOURCES:
		return "BT_HCI_ERR_INSUFFICIENT_RESOURCES(0x0d)";
	case BT_HCI_ERR_INSUFFICIENT_SECURITY:
		return "BT_HCI_ERR_INSUFFICIENT_SECURITY(0x0e)";
	case BT_HCI_ERR_BD_ADDR_UNACCEPTABLE:
		return "BT_HCI_ERR_BD_ADDR_UNACCEPTABLE(0x0f)";
	case BT_HCI_ERR_CONN_ACCEPT_TIMEOUT:
		return "BT_HCI_ERR_CONN_ACCEPT_TIMEOUT(0x10)";
	case BT_HCI_ERR_UNSUPP_FEATURE_PARAM_VAL:
		return "BT_HCI_ERR_UNSUPP_FEATURE_PARAM_VAL(0x11)";
	case BT_HCI_ERR_INVALID_PARAM:
		return "BT_HCI_ERR_INVALID_PARAM(0x12)";
	case BT_HCI_ERR_REMOTE_USER_TERM_CONN:
		return "BT_HCI_ERR_REMOTE_USER_TERM_CONN(0x13)";
	case BT_HCI_ERR_REMOTE_LOW_RESOURCES:
		return "BT_HCI_ERR_REMOTE_LOW_RESOURCES(0x14)";
	case BT_HCI_ERR_REMOTE_POWER_OFF:
		return "BT_HCI_ERR_REMOTE_POWER_OFF(0x15)";
	case BT_HCI_ERR_LOCALHOST_TERM_CONN:
		return "BT_HCI_ERR_LOCALHOST_TERM_CONN(0x16)";
	case BT_HCI_ERR_REPEATED_ATTEMPTS:
		return "BT_HCI_ERR_REPEATED_ATTEMPTS(0x17)";
	case BT_HCI_ERR_PAIRING_NOT_ALLOWED:
		return "BT_HCI_ERR_PAIRING_NOT_ALLOWED(0x18)";
	case BT_HCI_ERR_UNKNOWN_LMP_PDU:
		return "BT_HCI_ERR_UNKNOWN_LMP_PDU(0x19)";
	case BT_HCI_ERR_UNSUPP_REMOTE_FEATURE:
		return "BT_HCI_ERR_UNSUPP_REMOTE_FEATURE(0x1a)";
	case BT_HCI_ERR_SCO_OFFSET_REJECTED:
		return "BT_HCI_ERR_SCO_OFFSET_REJECTED(0x1b)";
	case BT_HCI_ERR_SCO_INTERVAL_REJECTED:
		return "BT_HCI_ERR_SCO_INTERVAL_REJECTED(0x1c)";
	case BT_HCI_ERR_SCO_AIR_MODE_REJECTED:
		return "BT_HCI_ERR_SCO_AIR_MODE_REJECTED(0x1d)";
	case BT_HCI_ERR_INVALID_LL_PARAM:
		return "BT_HCI_ERR_INVALID_LL_PARAM(0x1e)";
	case BT_HCI_ERR_UNSPECIFIED:
		return "BT_HCI_ERR_UNSPECIFIED(0x1f)";
	case BT_HCI_ERR_UNSUPP_LL_PARAM_VAL:
		return "BT_HCI_ERR_UNSUPP_LL_PARAM_VAL(0x20)";
	case BT_HCI_ERR_ROLE_CHANGE_NOT_ALLOWED:
		return "BT_HCI_ERR_ROLE_CHANGE_NOT_ALLOWED(0x21)";
	case BT_HCI_ERR_LL_RESP_TIMEOUT:
		return"BT_HCI_ERR_LL_RESP_TIMEOUT(0x22)";
	case BT_HCI_ERR_LL_PROC_COLLISION:
		return "BT_HCI_ERR_LL_PROC_COLLISION(0x23)";
	case BT_HCI_ERR_LMP_PDU_NOT_ALLOWED:
		return "BT_HCI_ERR_LMP_PDU_NOT_ALLOWED(0x24)";
	case BT_HCI_ERR_ENC_MODE_NOT_ACCEPTABLE:
		return "BT_HCI_ERR_ENC_MODE_NOT_ACCEPTABLE(0x25)";
	case BT_HCI_ERR_LINK_KEY_CANNOT_BE_CHANGED:
		return "BT_HCI_ERR_LINK_KEY_CANNOT_BE_CHANGED(0x26)";
	case BT_HCI_ERR_REQUESTED_QOS_NOT_SUPPORTED:
		return "BT_HCI_ERR_REQUESTED_QOS_NOT_SUPPORTED(0x27)";
	case BT_HCI_ERR_INSTANT_PASSED:
		return "BT_HCI_ERR_INSTANT_PASSED(0x28)";
	case BT_HCI_ERR_PAIRING_NOT_SUPPORTED:
		return "BT_HCI_ERR_PAIRING_NOT_SUPPORTED(0x29)";
	case BT_HCI_ERR_DIFF_TRANS_COLLISION:
		return "BT_HCI_ERR_DIFF_TRANS_COLLISION(0x2a)";
	case BT_HCI_ERR_QOS_UNACCEPTABLE_PARAM:
		return "BT_HCI_ERR_QOS_UNACCEPTABLE_PARAM(0x2c)";
	case BT_HCI_ERR_QOS_REJECTED:
		return "BT_HCI_ERR_QOS_REJECTED(0x2d)";
	case BT_HCI_ERR_CHAN_ASSESS_NOT_SUPPORTED:
		return "BT_HCI_ERR_CHAN_ASSESS_NOT_SUPPORTED(0x2e)";
	case BT_HCI_ERR_INSUFF_SECURITY:
		return "BT_HCI_ERR_INSUFF_SECURITY(0x2f)";
	case BT_HCI_ERR_PARAM_OUT_OF_MANDATORY_RANGE:
		return "BT_HCI_ERR_PARAM_OUT_OF_MANDATORY_RANGE(0x30)";
	case BT_HCI_ERR_ROLE_SWITCH_PENDING:
		return "BT_HCI_ERR_ROLE_SWITCH_PENDING(0x32)";
	case BT_HCI_ERR_RESERVED_SLOT_VIOLATION:
		return "BT_HCI_ERR_RESERVED_SLOT_VIOLATION(0x34)";
	case BT_HCI_ERR_ROLE_SWITCH_FAILED:
		return "BT_HCI_ERR_ROLE_SWITCH_FAILED(0x35)";
	case BT_HCI_ERR_EXT_INQ_RESP_TOO_LARGE:
		return "BT_HCI_ERR_EXT_INQ_RESP_TOO_LARGE(0x36)";
	case BT_HCI_ERR_SIMPLE_PAIR_NOT_SUPP_BY_HOST:
		return "BT_HCI_ERR_SIMPLE_PAIR_NOT_SUPP_BY_HOST(0x37)";
	case BT_HCI_ERR_HOST_BUSY_PAIRING:
		return "BT_HCI_ERR_HOST_BUSY_PAIRING(0x38)";
	case BT_HCI_ERR_CONN_REJECTED_DUE_TO_NO_CHAN:
		return "BT_HCI_ERR_CONN_REJECTED_DUE_TO_NO_CHAN(0x39)";
	case BT_HCI_ERR_CONTROLLER_BUSY:
		return "BT_HCI_ERR_CONTROLLER_BUSY(0x3a)";
	case BT_HCI_ERR_UNACCEPT_CONN_PARAM:
		return "BT_HCI_ERR_UNACCEPT_CONN_PARAM(0x3b)";
	case BT_HCI_ERR_ADV_TIMEOUT:
		return "BT_HCI_ERR_ADV_TIMEOUT(0x3c)";
	case BT_HCI_ERR_TERM_DUE_TO_MIC_FAIL:
		return "BT_HCI_ERR_TERM_DUE_TO_MIC_FAIL(0x3d)";
	case BT_HCI_ERR_CONN_FAIL_TO_ESTAB:
		return "BT_HCI_ERR_CONN_FAIL_TO_ESTAB(0x3e)";
	case BT_HCI_ERR_MAC_CONN_FAILED:
		return "BT_HCI_ERR_MAC_CONN_FAILED(0x3f)";
	case BT_HCI_ERR_CLOCK_ADJUST_REJECTED:
		return "BT_HCI_ERR_CLOCK_ADJUST_REJECTED(0x40)";
	case BT_HCI_ERR_SUBMAP_NOT_DEFINED:
		return "BT_HCI_ERR_SUBMAP_NOT_DEFINED(0x41)";
	case BT_HCI_ERR_UNKNOWN_ADV_IDENTIFIER:
		return "BT_HCI_ERR_UNKNOWN_ADV_IDENTIFIER(0x42)";
	case BT_HCI_ERR_LIMIT_REACHED:
		return "BT_HCI_ERR_LIMIT_REACHED(0x43)";
	case BT_HCI_ERR_OP_CANCELLED_BY_HOST:
		return "BT_HCI_ERR_OP_CANCELLED_BY_HOST(0x44)";
	case BT_HCI_ERR_PACKET_TOO_LONG:
		return "BT_HCI_ERR_PACKET_TOO_LONG(0x45)";
	case BT_HCI_ERR_TOO_LATE:
		return "BT_HCI_ERR_TOO_LATE(0x46)";
	case BT_HCI_ERR_TOO_EARLY:
		return "BT_HCI_ERR_TOO_EARLY(0x47)";
	default:
		return "Unknown_HCI_ERR";
	}
}
