...
int main(void)
{
	...
	lv_demo_scroll();
#elif defined(CONFIG_LV_Z_DEMO_VECTOR_GRAPHIC)
	lv_demo_vector_graphic();
#elif defined(CONFIG_LV_Z_DEMO_MULTILANG)
	lv_demo_multilang();
#else
#error Enable one of the demos CONFIG_LV_Z_DEMO_MUSIC, CONFIG_LV_Z_DEMO_BENCHMARK ,\
	CONFIG_LV_Z_DEMO_STRESS, CONFIG_LV_Z_DEMO_WIDGETS, CONFIG_LV_Z_DEMO_FLEX_LAYOUT,\
	CONFIG_LV_Z_DEMO_KEYPAD_AND_ENCODER, CONFIG_LV_Z_DEMO_RENDER, CONFIG_LV_Z_DEMO_SCROLL, \
	CONFIG_LV_Z_DEMO_VECTOR_GRAPHIC or CONFIG_LV_Z_DEMO_MULTILANG
#endif
